...
def Laguerre_Gauss_Circular_Harmonic_3_0(size, sigma):
    ...
    l30 = numpy.expand_dims(l30, 2)
    l30 = numpy.concatenate((l30, l30, l30), 2)
    return l30
...
def Laguerre_Gauss_Circular_Harmonic_1_0(size, sigma):
    ...
    l10 = numpy.expand_dims(l10, 2)
    l10 = numpy.concatenate((l10, l10, l10), 2)
    return l10
...
def pec(img):
    ...
    l10 = Laguerre_Gauss_Circular_Harmonic_1_0(16, 2)
    l30 = Laguerre_Gauss_Circular_Harmonic_3_0(16, 2)
